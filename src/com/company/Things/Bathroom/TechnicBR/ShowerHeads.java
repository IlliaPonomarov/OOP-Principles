package com.company.Things.Bathroom.TechnicBR;

import com.company.Things.Technic;

public class ShowerHeads extends Technic {
    private String name;
    ...
    public ShowerHeads(String name, double price, boolean avail_guarantie, boolean presence_bolts, String color, int avail_warehouse, int height, int width){
        this.name = name;
        this.setPrice(price);
